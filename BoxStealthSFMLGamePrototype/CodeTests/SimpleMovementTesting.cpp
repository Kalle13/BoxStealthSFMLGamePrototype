// SimpleMovementTesting.cpp

// NOTE: This file has not been added to the 'BoxStealthSFMLGamePrototype' project

#include "Game/GameLoop.h"

// Uses a few Engine Systems and sees how they work together (July 29, 2017)
void SimpleMovementTesting()
{
	GameInput gameInput;
